...
function AtivasContent() {
  ...
  return (
    <div className="flex flex-col items-center text-[var(--color-grey)] w-full max-w-3xl">
      ...
      <p className="text-center">Nenhuma receita ativa disponível no momento.</p>
    </div>
  );
}

function InativasContent() {
  const [filtroAtivo, setFiltroAtivo] = useState<"3" | "6" | "12">("3");
  ...
  return (
    <div className="flex flex-col items-center text-[var(--color-grey)] w-full max-w-3xl">
      <ul className="flex flex-wrap justify-center gap-3 mb-6">
        ...
        <p className="text-center">Nenhuma receita inativa disponível no momento.</p>
    </div>
  );
}
