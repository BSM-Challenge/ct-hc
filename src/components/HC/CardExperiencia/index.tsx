    ...
    return (
        ...
        ">
            ...
            ">
                ...
                max-sm:text-2xl
                ">Torne sua experiência mais acessível!</h3>
                <p className="
                ...
                max-sm:text-lg
                ">
                   Personalize sua navegação! Clique aqui para acessar
                   as opções de acessibilidade, saiba como ajustar a fonte, contraste e mais.
                </p>
            </div>
        </div>
    )
