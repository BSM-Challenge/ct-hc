export default function Error() {
    return (
        <main className="relative ">
            ...
            <button className="text-[var(--color-blue)] rounded-4xl w-40 h-14 font-semibold text-3xl absolute bottom-12 right-4 cursor-pointer mb-5 mr-5 border-4 border-solid border-[var(--color-blue)] hover:bg-[var(--light-blue-2)] hover:text-[var(--color-white)] hover:border-solid hover:border-[var(--Color-blue-709CFF)]" onClick={() => window.location.href = '/'}>Voltar</button>
            <div className="w-full h-10 bg-[var(--Color-blue-709CFF)]"></div>
