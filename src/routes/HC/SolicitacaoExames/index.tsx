  ...
  return (
    <section className="flex flex-col gap-5 min-h-full">
        ...
        >
          ...
          >
            ...
            >
              <FaUserDoctor
                size={23}
                className="text-[var(--color-blue-4383B4)]"
              />
              <figcaption className="text-[var(--color-blue-4383B4)] text-xl">
                Situação de pedido de exames
              </figcaption>
            </figure>
            ...
            >
              ...
              >
                <label className="font-light">
                  Informe o RGHC (matrícula) ou o CPF do paciente
                </label>
                <input
                  type="text"
              ...
              >
                ...
                <p className="font-light">
                  O RGHC é a matrícula do paciente na instituição, ele é
                  composto por números e uma letra e está impresso na filipeta
      ...
      <div className="flex flex-col items-center px-10">
        <h3>
          <span className="text-[var(--color-blue-4383B4)]">NETi</span> HCFMUSP
          © 2016-2023
        </h3>
      </div>
    </section>
