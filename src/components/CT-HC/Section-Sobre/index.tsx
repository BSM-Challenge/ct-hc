        ...
        bg-[var(--color-white)] min-h-screen p-4
         ...
         >
            ...
            <div className="w-full flex flex-col items-start justify-around gap-15 lg:flex-row lg:justify-between">
                <figcaption>
                    <img src="https://res.cloudinary.com/dt26mfzpw/image/upload/v1761433387/img-hospital_ygvzzr.png" alt=""  className="h-[450px]"/>
                </figcaption>
        ...
        >
                    ...
                    <ul className="flex flex-col items-start gap-10 lg:items-center">
                        <li className="flex items-center gap-5 lg:justify-center">
                            <img src="https://res.cloudinary.com/dt26mfzpw/image/upload/v1761433483/icon-information_dl95l8.png" alt=""/>
                            <p className="text-2xl w-full lg:w-[50%] lg:text-3xl">
                                Destacamos os pontos de atenção mais críticos do portal. 
                            </p>
                        </li>
                        <li className="flex items-center gap-5 lg:justify-center">
                            <img src="https://res.cloudinary.com/dt26mfzpw/image/upload/v1761433556/icon-popups_bojuhv.png" alt=""/>
                            <p className="text-2xl w-full lg:w-[50%] lg:text-3xl">
                        ...
                        <li className="flex items-center gap-4 -ml-3 lg:justify-center lg:ml-0">
                            <img src="https://res.cloudinary.com/dt26mfzpw/image/upload/v1761433584/icon-tarefas_qegr7r.png" alt=""/>
                            <p className="text-2xl w-full lg:w-[50%] lg:text-3xl">
