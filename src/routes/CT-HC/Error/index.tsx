  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        sm:w-150 lg:w-250 lg:mb-15 xl:w-300 2xl:w-400 2xl:text-5xl 2xl:mt-">
      ...
      <div className="flex justify-end">
        ...
        hover:bg-[var(--light-blue-2)] hover:text-[var(--color-white)]
        hover:border-[var(--Color-blue-709CFF)] transition-colors duration-200 lg:mr-10" to="/">
          Voltar
        </Link>
      </div>
      </main>
