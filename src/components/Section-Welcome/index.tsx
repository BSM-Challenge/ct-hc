...
export default function SectionWelcome() {
  return (
    <section className="flex flex-col pt-30 lg:pt-50 lg:flex-row">
      <div className="flex justify-center flex-col w-full gap-3 lg:w-1/2 opacity-0 animate-fade-in lg: px-4 lg:px-0">
        <h1
          className="text-2xl sm:text-3xl md:text-4xl lg:text-[2.30rem]  xl:text-[60px] text-center text-[var(--dark-blue-title)] font-bold"
          style={{ fontFamily: "Inter" }}
        >
          Bem-vindo ao Centro de Treinamento do Hospital das Clínicas!
        </h1>
        <p className="text-base sm:text-lg md:text-xl md:text-center lg:text-1xl mt-4 lg:mt-8 lg:ml-10 indent-4 lg:indent-8 text-justify lg:text-left  xl:text-2xl">
      ...
      <div className="w-full lg:w-1/2 flex justify-center lg:-mt-50 px-4 lg:px-0">
        <img 
          ...
          className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-none lg:h-[600px] lg:mt-30 lg:ml-10 xl:h-[700px] xl:mt-15 opacity-0 animate-fade-in object-contain"
        />
      </div>
    </section>
  );
