  ...
  return (
    ...
    sm:pt-30 sm:px-15 lg:pt-40 2xl:px-40">
      ...
      sm:flex-col lg:flex-row 2xl:h-[100%] 2xl:w-[100%]">
        <section className="bg-[var(--light-blue-2)] rounded-3xl p-3 flex-1 w-[100%] shadow-xl/20 mb-10
        ...
        <section className="bg-[var(--color-white)] rounded-3xl shadow-xl/20
        sm:w-[80%] sm:rounded-3xl sm:self-center sm:mb-10
        ...
        xl:h-[620px]">
          ...
          <div className="flex flex-col justify-center items-center w-[100%] h-[100%] sm:mt-5 xl:py-9">
            {!mensagem ? (
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col justify-center w-[80%] h-[100%]
              sm:w-[80%] md:w-[70%]
              ...
              xl:w-[75%]">
                ...
                <input type="text" placeholder="Digite o seu nome" className="bg-[var(--light-blue)] w-[100%] placeholder:text-[var(--dark-blue-2)] placeholder:font-bold rounded-md py-[5px] pl-3 mb-2 border-b-4 border-[var(--dark-blue-title)] lg:mb-5" {...register("nome")} />
                {errors.nome && (<p className="text-red-500 font-semibold text-sm mb-7
                lg:mb-2">{errors.nome.message}</p>)}

                <label htmlFor="email" className="text-[var(--dark-blue-title)] font-bold text-3xl mb-1">E-mail:</label>
                <input type="email" placeholder="Digite o seu e-mail" className="bg-[var(--light-blue)] placeholder:text-[var(--dark-blue-2)] placeholder:font-bold rounded-md py-[5px] pl-3 mb-2 border-b-4 border-[var(--dark-blue-title)] lg:mb-5" {...register("email")} />
                {errors.email && (<p className="text-red-500 font-semibold text-sm mb-7
                lg:mb-2">{errors.email.message}</p>)}
                ...
                <textarea placeholder="Digite sua mensagem..."
                  ...
                  lg:h-25
                  xl:h-44" {...register("mensagem")} />
                {errors.mensagem && (<p className="text-red-500 font-semibold text-sm mb-7
                lg:mb-2">{errors.mensagem.message}</p>)}
                ...
                xl:mb-0 xl:text-3xl xl:w-[35%]"> {carregando ? "Enviando..." : "Enviar"}</button>
              </form>
            ) : (
              <div className="rounded-3xl flex flex-col p-8
              lg:rounded-r-none lg:mb-8 lg:w-[100%]
              xl:p-15
              2xl:p-25">
                <h4 className="text-4xl text-center font-semibold text-[var(--dark-blue-title)]
                ...
                <h5 className="text-3xl text-center text-[var(--dark-blue-title)]
                xl:text-4xl">Deseja fazer outra pergunta?</h5>
                <ul className="flex flex-col justify-center items-center w-full gap-6 mt-3
                sm:flex-row
                xl:mt-5 xl:gap-15">
                  <li>
                    <button
