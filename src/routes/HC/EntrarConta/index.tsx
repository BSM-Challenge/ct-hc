...
export default function EntrarConta() {
  return (
    <section className="w-full min-h-screen bg-background-linear flex justify-center items-center px-5">
      <div className="bg-[var(--color-white-button-hover)] rounded-[20px] border-2 border-[var(--color-white)] p-6">
        <span className="flex justify-center mb-3 md:mb-5">
          <img src="logo-hc-verde.png" alt="Logo do HC" className="w-full" />
        </span>
        ...
        <div className="flex flex-col items-center">
          <form className="flex flex-col md:w-[70%]">
            <label className="text-[var(--color-white)] text-3xl font-bold mb-3" htmlFor="">
              E-mail ou CPF:
            </label>
            <input
              type="text"
        ...
        <ul className="flex flex-col-reverse md:flex-row md:justify-between">
          ...
          <li>
            <Link
              ...
              className="
                        text-[var(--color-white)] text-center px-7 py-3 flex justify-self-center
